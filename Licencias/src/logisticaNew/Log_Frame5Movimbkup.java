...
public class Log_Frame5Movimbkup {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					Log_Frame5Movimbkup window = new Log_Frame5Movimbkup();
	...
	private void initialize() {
		...
		Ventana05.setBounds(100, 30, 950, 600);
		...
		scrollPane.setBounds(22, 159, 900, 328);
...
//
//	private JComboBox comboBoxIZQ;
//	private JComboBox comboBoxDER;
...
//	private JComboBox box2;
	...
	private final String pstConsulta1 = "SELECT fecha, hora, idProducto, producto, movimCantidad, movimTipo, movimUsuario "
			+ "FROM "+tablaMovim+" WHERE movimTipo=? AND fecha =?"; // FINAL para que sea constante y no pueda ser modificada

	private String pstConsulta2 = "SELECT fecha, hora, idProducto, producto, movimCantidad, movimTipo, movimUsuario "
